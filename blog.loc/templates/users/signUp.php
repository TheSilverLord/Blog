    ...
    <div class="wrapper">
        ...
        <form action="/users/register" method="post">
            <div>
                ...
                <input class="user-input" type="text" name="nickname" value="<?= $_POST['nickname'] ?? '' ?>" />
            </div> 
            <div>
                <label class="emailSign" for="text">
                    @
                </label>
                <input class="user-input" type="text" name="email" value="<?= $_POST['email'] ?? '' ?>" />
            </div> 
            <div>
